...
<head>
    ...
    <title>Nová rezervace - Admin</title>
    ...
    <div class="admin-layout">
        ...
        <main class="admin-content">
            <div class="page-header">
                <h1><i class="fas fa-plus"></i> Nová rezervace</h1>
                ...
                <div class="card-body">
                    <form method="POST">
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" id="customer_email" name="customer_email"
                                       value="<?php echo htmlspecialchars($data['customer_email'] ?? ''); ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="tel" id="customer_phone" name="customer_phone"
                                       value="<?php echo htmlspecialchars($data['customer_phone'] ?? ''); ?>" required>
                            </div>

                            <div class="form-group">
                                <label for="guest_count">Počet hostů</label>
                                <input type="number" id="guest_count" name="guest_count" min="1"
                                       value="<?php echo htmlspecialchars($data['guest_count'] ?? ''); ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="date" id="reservation_date" name="reservation_date"
                                       value="<?php echo htmlspecialchars($data['reservation_date'] ?? ''); ?>" required>
                            </div>

                            <div class="form-group">
                                <label for="reservation_time">Čas</label>
                                <input type="time" id="reservation_time" name="reservation_time"
                                       value="<?php echo htmlspecialchars($data['reservation_time'] ?? ''); ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                                ...
                                <select id="table_id" name="table_id" required>
                                    ...
                                    <?php foreach ($tables as $table): ?>
                                        <option value="<?php echo $table['id']; ?>"
                                                <?php echo ($data['table_id'] ?? '') == $table['id'] ? 'selected' : ''; ?>>
                            ...
                            <div class="form-group">
                                ...
                                <select id="status" name="status" required>
                                    <option value="pending" <?php echo ($data['status'] ?? '') === 'pending' ? 'selected' : ''; ?>>Čeká</option>
                                    <option value="confirmed" <?php echo ($data['status'] ?? '') === 'confirmed' ? 'selected' : ''; ?>>Potvrzeno</option>
                                    <option value="cancelled" <?php echo ($data['status'] ?? '') === 'cancelled' ? 'selected' : ''; ?>>Zrušeno</option>
                                    <option value="completed" <?php echo ($data['status'] ?? '') === 'completed' ? 'selected' : ''; ?>>Dokončeno</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="special_requests" name="special_requests" rows="3"><?php echo htmlspecialchars($data['special_requests'] ?? ''); ?></textarea>
                        </div>
